 ...
 * <p>10 Sep 2015
 */
public class OpDistinct<Node> extends OpModifier<Node> {
  public OpDistinct(Op<Node> subOp) {
    super(subOp);
  }
  ...
  public Op<Node> copy(Op<Node> subOp) {
    return new OpDistinct<Node>(subOp);
  }
  ...
  public boolean equalTo(Op<Node> other) {
    ...
    return getSubOp().equalTo(((OpDistinct<Node>) other).getSubOp());
  }
}
