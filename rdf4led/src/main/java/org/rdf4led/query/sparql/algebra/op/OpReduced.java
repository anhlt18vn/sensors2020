 ...
 * <p>10 Sep 2015
 */
public class OpReduced<Node> extends OpModifier<Node> {
  public OpReduced(Op<Node> subOp) {
    super(subOp);
  }
  ...
  public Op<Node> copy(Op<Node> subOp) {
    return new OpReduced<Node>(subOp);
  }
  ...
  public boolean equalTo(Op<Node> other) {
    ...
    return getSubOp().equalTo(((OpReduced<Node>) other).getSubOp());
  }
}
