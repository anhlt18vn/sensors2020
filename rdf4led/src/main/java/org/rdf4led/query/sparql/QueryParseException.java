...
/**
 * QueryParseException is root exception for all (intentional) exceptions from the various parsers
 * where the error is to do with the org.rdf4led.sparql.algebra.syntax of a query.
 */
