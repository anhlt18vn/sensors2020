...
import org.rdf4led.query.sparql.parser.lang.ParserQueryBase;
import org.rdf4led.query.sparql.syntax.*;

public class SPARQLParser11<Node> extends ParserQueryBase<Node> implements SPARQLParser11Constants {
      ...
      case LPAREN:
        ...
        while (true) {
          switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
            ...
            case VAR2:
              v = Var();
              if (!queryContext.isVarNode(v)) {
                throw new RuntimeException(v + " v is not Var");
              }
            ...
            case LPAREN:
              ...
              if (!queryContext.isVarNode(v)) {
                throw new RuntimeException(v + " is not a variable ");
              }
  ...
  public final void ConstructQuery() throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      ...
      case WHERE:
        ...
        t = new Template<Node>(acc.getBGP());

        getQuery().setConstructTemplate(t);

        // Create a query in the same shape as the query created by
        // writing
        // out in full.
        ElementPathBlock<Node> epb = new ElementPathBlock<>(acc.getBGP(), queryContext);

        ElementGroup<Node> elg = new ElementGroup<>();
  ...
  // SPARQL Update + transitional extensions for SPARQL/Update (the W3C
  // submission)
  ...
  // final public void UsingClause(UpdateWithUsing update) throws
  // ParseException {
  // String iri;
  // int n;
  ...
  // final public void QuadData(QuadDataAcc org.rdf4led.common.data.incremental.acc) throws ParseException {
  // jj_consume_token(LBRACE);
  // Quads(org.rdf4led.common.data.incremental.acc);
  // jj_consume_token(RBRACE);
  // }

  // final public void Quads(QuadAcc org.rdf4led.common.data.incremental.acc) throws ParseException {
  // switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
  // case IRIref:
  // case PNAME_NS:
  // case PNAME_LN:
  ...
  // final public void QuadsNotTriples(QuadAcc org.rdf4led.common.data.incremental.acc) throws ParseException {
  // int gn;
  // int prev = org.rdf4led.common.data.incremental.acc.getGraph();
  // jj_consume_token(GRAPH);
  // gn = VarOrIri();
  ...
  public final Element<Node> GroupGraphPattern() throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case SELECT:
        ...
        SubSelect();
        Query<Node> q = endSubSelect(t.beginLine, t.beginColumn);
  ...
  public final Element<Node> TriplesBlock(ElementPathBlock<Node> acc) throws ParseException {
    ...
    if (acc == null) {
      acc = new ElementPathBlock<Node>(queryContext);
    }
  ...
  public final Expr<Node> FunctionCall() throws ParseException {
    ...
    a = ArgList();
    {
      if (true) return new E_Function<Node>(fname, a, queryContext);
    }
    throw new Error("Missing return statement in function");
  }
  ...
  public final void TriplesSameSubject(TripleCollector<Node> acc) throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      ...
      case LPAREN:
      case LBRACKET:
        // Any of the triple generating org.rdf4led.sparql.algebra.syntax elements
        s = TriplesNode(acc);
        PropertyList(s, acc);
        break;
      default:
  ...
  public final Path<Node> PathElt() throws ParseException {
    Path<Node> p;
  ...
  public final Path<Node> PathEltOrInverse() throws ParseException {
    Path<Node> p;
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case IRIref:
      case PNAME_NS:
  ...
  public final Path<Node> PathMod(Path<Node> p) throws ParseException {
    long i1;
    long i2;
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case QMARK:
        ...
        {
          if (true) {
            return new P_ZeroOrOne<Node>(p);
            // return queryContext.getPathZeroOrOne(p);
          }
        }
        break;
      case STAR:
        ...
        {
          if (true) {
            return new P_ZeroOrMore1<Node>(p);
            // return queryContext.getPathZeroOrMore1(p);
          }
        }
        break;
      case PLUS:
        ...
        {
          if (true) {
            return new P_OneOrMore1<Node>(p);
            // return queryContext.getPathOneOrMore1(p);
          }
        }
        break;
      default:
  ...
  public final Path<Node> PathPrimary() throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      ...
      case PNAME_LN:
        ...
        p = new P_Link<Node>(n);
        // queryContext.getPathLink(n);
        break;

      case KW_A:
        jj_consume_token(KW_A);
        p = new P_Link<Node>(RDFtype);
        // queryContext.getPathLink(RDFtype);
        break;
      case BANG:
  ...
  public final P_Path0<Node> PathOneInPropertySet() throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      ...
      case KW_A:
        jj_consume_token(KW_A);
        {
          if (true) return new P_Link<Node>(RDFtype);
        }
        break;
      case CARAT:
        jj_consume_token(CARAT);
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
          ...
          case KW_A:
            jj_consume_token(KW_A);
            {
              if (true) return new P_ReverseLink<Node>(RDFtype);
            }
            break;
          default:
            jj_la1[111] = jj_gen;
  ...
  public final Node Collection(TripleCollector<Node> acc) throws ParseException {
    ...
    while (true) {
      ...
      if (lastCell != null) {
        insert(acc, lastCell, RDFrest, cell);
      }
      ...
      insert(acc, mark, cell, RDFfirst, n);
    ...
    jj_consume_token(RPAREN);
    if (lastCell != null) insert(acc, lastCell, RDFrest, RDFnil);
    {
  ...
  public final Node CollectionPath(TripleCollector<Node> acc) throws ParseException {
    ...
    while (true) {
      Node cell = createListNode(t.beginLine, t.beginColumn);
      if (listHead == RDFnil) listHead = cell;
      if (lastCell != null) insert(acc, lastCell, RDFrest, cell);
      mark = acc.mark();
      n = GraphNodePath(acc);
      insert(acc, mark, cell, RDFfirst, n);
      lastCell = cell;
  ...
  // -------- Constraint org.rdf4led.sparql.algebra.syntax
  ...
  public final Expr<Node> ConditionalOrExpression() throws ParseException {
    ...
    while (true) {
      ...
      expr1 = new E_LogicalOr<Node>(expr1, expr2, queryContext);
    }
    {
      if (true) {
        return expr1;
  ...
  public final Expr<Node> ConditionalAndExpression() throws ParseException {
    ...
    while (true) {
      ...
      expr1 = new E_LogicalAnd<Node>(expr1, expr2, queryContext);
    }
    {
      ...
      case GE:
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
          case EQ:
            ...
            expr1 = new E_Equals<Node>(expr1, expr2, queryContext);
            break;
          case NE:
            jj_consume_token(NE);
            expr2 = NumericExpression();
            expr1 = new E_NotEquals<Node>(expr1, expr2, queryContext);
            break;
          case LT:
            jj_consume_token(LT);
            expr2 = NumericExpression();
            expr1 = new E_LessThan<Node>(expr1, expr2, queryContext);
            break;
          case GT:
            jj_consume_token(GT);
            expr2 = NumericExpression();
            expr1 = new E_GreaterThan<Node>(expr1, expr2, queryContext);
            break;
          case LE:
            jj_consume_token(LE);
            expr2 = NumericExpression();
            expr1 = new E_LessThanOrEqual<Node>(expr1, expr2, queryContext);
            break;
          case GE:
            jj_consume_token(GE);
            expr2 = NumericExpression();
            expr1 = new E_GreaterThanOrEqual<Node>(expr1, expr2, queryContext);
            break;
          case IN:
            jj_consume_token(IN);
            a = ExpressionList();
            expr1 = new E_OneOf<Node>(expr1, a, queryContext);
            break;
          case NOT:
            jj_consume_token(NOT);
            jj_consume_token(IN);
            a = ExpressionList();
            expr1 = new E_NotOneOf<Node>(expr1, a, queryContext);
            break;
          default:
            jj_la1[125] = jj_gen;
            jj_consume_token(-1);
    ...
    while (true) {
      ...
      switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
        case PLUS:
          ...
          expr1 = new E_Add<Node>(expr1, expr2, queryContext);
          break;
        case MINUS:
          jj_consume_token(MINUS);
          expr2 = MultiplicativeExpression();
          expr1 = new E_Subtract<Node>(expr1, expr2, queryContext);
          break;
        case INTEGER_POSITIVE:
        case DECIMAL_POSITIVE:
        case DOUBLE_POSITIVE:
        ...
        case DOUBLE_NEGATIVE:
          ...
          while (true) {
            ...
            switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
              case STAR:
                ...
                expr2 = new E_Multiply<Node>(expr2, expr3, queryContext);
                break;
              case SLASH:
                jj_consume_token(SLASH);
                expr3 = UnaryExpression();
                expr2 = new E_Divide<Node>(expr2, expr3, queryContext);
                break;
              default:
                jj_la1[130] = jj_gen;
                jj_consume_token(-1);
          ...
          if (addition) expr1 = new E_Add<Node>(expr1, expr2, queryContext);
          else expr1 = new E_Subtract<Node>(expr1, expr2, queryContext);
          break;
        default:
          jj_la1[131] = jj_gen;
          jj_consume_token(-1);
    ...
    while (true) {
      ...
      switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
        case STAR:
          ...
          expr1 = new E_Multiply<Node>(expr1, expr2, queryContext);
          break;
        case SLASH:
          jj_consume_token(SLASH);
          expr2 = UnaryExpression();
          expr1 = new E_Divide<Node>(expr1, expr2, queryContext);
          break;
        default:
          jj_la1[133] = jj_gen;
          jj_consume_token(-1);
  ...
  public final Expr<Node> UnaryExpression() throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case BANG:
        ...
        {
          if (true) return new E_LogicalNot<Node>(expr, queryContext);
        }
        break;
      case PLUS:
        jj_consume_token(PLUS);
        expr = PrimaryExpression();
        {
          if (true) return new E_UnaryPlus<Node>(expr, queryContext);
        }
        break;
      case MINUS:
        jj_consume_token(MINUS);
        expr = PrimaryExpression();
        {
          if (true) return new E_UnaryMinus<Node>(expr, queryContext);
        }
        break;
      case IRIref:
      case PNAME_NS:
  ...
  public final Expr<Node> PrimaryExpression() throws ParseException {
    Expr<Node> expr;
    Node gn;
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      case LPAREN:
  ...
  public final Expr<Node> BuiltInCall() throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      ...
      case STR:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_Str<Node>(expr, queryContext);
        }
        break;
      case LANG:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_Lang<Node>(expr, queryContext);
        }
        break;
      case LANGMATCHES:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_LangMatches<Node>(expr1, expr2, queryContext);
        }
        break;
      case DTYPE:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_Datatype<Node>(expr, queryContext);
        }
        break;
      case BOUND:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_Bound<Node>(new ExprVar<Node>(gn, queryContext), queryContext);
        }
        break;
      case IRI:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_IRI<Node>(expr, queryContext);
        }
        break;
      case URI:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_URI<Node>(expr, queryContext);
        }
        break;
      case BNODE:
        ...
        switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
          case LPAREN:
            ...
            jj_consume_token(RPAREN);
            {
              if (true) return new E_BNode<Node>(expr1, queryContext);
            }
            break;
          case NIL:
            jj_consume_token(NIL);
            {
              if (true) return new E_BNode(queryContext);
            }
            break;
          default:
            jj_la1[136] = jj_gen;
      ...
      case RAND:
        ...
        jj_consume_token(NIL);
        {
          if (true) return new E_Random<Node>(queryContext);
        }
        break;
      case ABS:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_NumAbs<Node>(expr1, queryContext);
        }
        break;
      case CEIL:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_NumCeiling<Node>(expr1, queryContext);
        }
        break;
      case FLOOR:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_NumFloor<Node>(expr1, queryContext);
        }
        break;
      case ROUND:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_NumRound<Node>(expr1, queryContext);
        }
        break;
      case CONCAT:
        ...
        a = ExpressionList();
        {
          if (true) return new E_StrConcat<Node>(a, queryContext);
        }
        break;
      case SUBSTR:
      ...
      case STRLEN:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrLength<Node>(expr1, queryContext);
        }
        break;
      case REPLACE:
      ...
      case UCASE:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrUpperCase<Node>(expr1, queryContext);
        }
        break;
      case LCASE:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrLowerCase<Node>(expr1, queryContext);
        }
        break;
      case ENCODE_FOR_URI:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrEncodeForURI<Node>(expr1, queryContext);
        }
        break;
      case CONTAINS:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrContains<Node>(expr1, expr2, queryContext);
        }
        break;
      case STRSTARTS:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrStartsWith<Node>(expr1, expr2, queryContext);
        }
        break;
      case STRENDS:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrEndsWith<Node>(expr1, expr2, queryContext);
        }
        break;
      case STRBEFORE:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrBefore<Node>(expr1, expr2, queryContext);
        }
        break;
      case STRAFTER:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrAfter<Node>(expr1, expr2, queryContext);
        }
        break;
      case YEAR:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_DateTimeYear<Node>(expr1, queryContext);
        }
        break;
      case MONTH:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_DateTimeMonth<Node>(expr1, queryContext);
        }
        break;
      case DAY:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_DateTimeDay<Node>(expr1, queryContext);
        }
        break;
      case HOURS:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_DateTimeHours<Node>(expr1, queryContext);
        }
        break;
      case MINUTES:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_DateTimeMinutes<Node>(expr1, queryContext);
        }
        break;
      case SECONDS:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_DateTimeSeconds<Node>(expr1, queryContext);
        }
        break;
      case TIMEZONE:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_DateTimeTimezone<Node>(expr1, queryContext);
        }
        break;
      case TZ:
        jj_consume_token(TZ);
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_DateTimeTZ<Node>(expr1, queryContext);
        }
        break;
      case NOW:
        ...
        jj_consume_token(NIL);
        {
          if (true) return new E_Now<Node>(queryContext);
        }
        break;
      case UUID:
        ...
        jj_consume_token(NIL);
        {
          if (true) return new E_UUID<Node>(queryContext);
        }
        break;
      case STRUUID:
        ...
        jj_consume_token(NIL);
        {
          if (true) return new E_StrUUID<Node>(queryContext);
        }
        break;
      case MD5:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_MD5<Node>(expr1, queryContext);
        }
        break;
      case SHA1:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_SHA1<Node>(expr1, queryContext);
        }
        break;
      case SHA256:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_SHA256<Node>(expr1, queryContext);
        }
        break;
      case SHA384:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_SHA384<Node>(expr1, queryContext);
        }
        break;
      case SHA512:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_SHA512<Node>(expr1, queryContext);
        }
        break;
      case COALESCE:
        ...
        a = ExpressionList();
        {
          if (true) return new E_Coalesce<Node>(a, queryContext);
        }
        break;
      case IF:
        jj_consume_token(IF);
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_Conditional<Node>(expr, expr1, expr2, queryContext);
        }
        break;
      case STRLANG:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrLang<Node>(expr1, expr2, queryContext);
        }
        break;
      case STRDT:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_StrDatatype<Node>(expr1, expr2, queryContext);
        }
        break;
      case SAME_TERM:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_SameTerm<Node>(expr1, expr2, queryContext);
        }
        break;
      case IS_IRI:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_IsIRI<Node>(expr, queryContext);
        }
        break;
      case IS_URI:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_IsURI<Node>(expr, queryContext);
        }
        break;
      case IS_BLANK:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_IsBlank<Node>(expr, queryContext);
        }
        break;
      case IS_LITERAL:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_IsLiteral<Node>(expr, queryContext);
        }
        break;
      case IS_NUMERIC:
        ...
        jj_consume_token(RPAREN);
        {
          if (true) return new E_IsNumeric<Node>(expr, queryContext);
        }
        break;
      case REGEX:
  ...
  public final Expr<Node> RegexExpression() throws ParseException {
    ...
    jj_consume_token(RPAREN);
    {
      if (true) return new E_Regex<Node>(expr, patExpr, flagsExpr, queryContext);
    }
    throw new Error("Missing return statement in function");
  }
  ...
  public final Expr<Node> SubstringExpression() throws ParseException {
    ...
    jj_consume_token(RPAREN);
    {
      if (true) return new E_StrSubstring<Node>(expr1, expr2, expr3, queryContext);
    }
    throw new Error("Missing return statement in function");
  }
  ...
  public final Expr<Node> StrReplaceExpression() throws ParseException {
    ...
    jj_consume_token(RPAREN);
    {
      if (true) return new E_StrReplace<Node>(expr1, expr2, expr3, expr4, queryContext);
    }
    throw new Error("Missing return statement in function");
  }
  ...
  public final Expr<Node> Aggregate() throws ParseException {
    ...
    switch ((jj_ntk == -1) ? jj_ntk() : jj_ntk) {
      ...
      case GROUP_CONCAT:
        ...
        agg = createAggGroupConcat(distinct, expr, sep, ordered);
        // agg = AggregatorFactoryInt.createGroupConcat
        break;
      default:
        jj_la1[150] = jj_gen;
        jj_consume_token(-1);
  ...
  public final Expr<Node> iriOrFunction() throws ParseException {
    ...
    {
      if (true) return new E_Function<Node>(iri, a, queryContext);
    }
    throw new Error("Missing return statement in function");
  }
  ...
  private int jj_ntk;
  private int jj_gen;
  private final int[] jj_la1 = new int[163];
  ...
  public SPARQLParser11(java.io.InputStream stream, QueryContext<Node> queryContext) {
    this(stream, null, queryContext);
  }

  /** Constructor with InputStream and supplied encoding */
  public SPARQLParser11(
      java.io.InputStream stream, String encoding, QueryContext<Node> queryContext) {
    super(queryContext);
  ...
  /** Constructor. */
  public SPARQLParser11(java.io.Reader stream, QueryContext<Node> queryContext) {
  ...
  public SPARQLParser11(SPARQLParser11TokenManager tm, QueryContext<Node> queryContext) {
