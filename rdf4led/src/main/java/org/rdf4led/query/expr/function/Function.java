 ...
 * <p>10 Sep 2015
 */
public interface Function<Node> {
  /**
   * Called during query plan construction immediately after the construction of the extension
   * instance. Can throw ExprBuildException if something is wrong (like wrong number of arguments).
   *
   * @param args The parsed arguements
   */
  public void build(String uri, ExprList<Node> args);

  /**
   * Test a list of values - argument will not be null but may have the wrong number of arguments.
   * FunctionBase provides a more convenient way to implement a function. Can throw
   * ExprEvalsException if something goes wrong.
   *
