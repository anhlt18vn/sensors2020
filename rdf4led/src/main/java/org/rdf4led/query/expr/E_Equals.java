 ...
 * <p>10 Sep 2015
 */
public class E_Equals<Node> extends ExprFunction2<Node> {
  public E_Equals(Expr<Node> left, Expr<Node> right, QueryContext<Node> queryContext) {
  ...
  public Expr<Node> copy(Expr<Node> e1, Expr<Node> e2) {
    return new E_Equals<Node>(e1, e2, queryContext);
  }
}
