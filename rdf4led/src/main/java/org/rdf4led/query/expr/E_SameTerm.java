 ...
 * <p>10 Sep 2015
 */
public class E_SameTerm<Node> extends ExprFunction2<Node> {

  public E_SameTerm(Expr<Node> left, Expr<Node> right, QueryContext<Node> queryContext) {
  ...
  public Node eval(Node x, Node y) {
    ...
    if (b) return queryContext.getnvTrue();
  ...
  public Expr<Node> copy(Expr<Node> e1, Expr<Node> e2) {
    return new E_SameTerm<Node>(e1, e2, queryContext);
  }
}
