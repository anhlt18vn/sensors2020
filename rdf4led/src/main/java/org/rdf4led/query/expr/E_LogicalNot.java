 ...
 * <p>10 Sep 2015
 */
public class E_LogicalNot<Node> extends ExprFunction1<Node> {
  // See logicalOR for truth table.

  // Errors propage as normal.
  public E_LogicalNot(Expr<Node> expr, QueryContext<Node> queryContext) {
    super(expr, queryContext);
  }

  @Override
  public Node eval(Node v) {
    return queryContext.getXSDFuncOp().not(v);
  }

  @Override
  public Expr<Node> copy(Expr<Node> expr) {
    return new E_LogicalNot<Node>(expr, queryContext);
  }
}
