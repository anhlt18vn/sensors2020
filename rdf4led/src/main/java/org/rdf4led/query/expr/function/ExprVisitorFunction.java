...
/**
 * Convert all visit calls on the expressions in a call to a generic visit operation for expession
 * functions
 */
/**
 * ExprVisitorFunction.java
 *
 ...
 * <p>10 Sep 2015
 */
public abstract class ExprVisitorFunction<Node> implements ExprVisitor<Node> {
  @Override
  ...
  protected abstract void visitExprFunction(ExprFunction<Node> func);
}
