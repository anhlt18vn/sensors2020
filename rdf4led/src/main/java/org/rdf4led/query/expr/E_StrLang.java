 ...
 * <p>10 Sep 2015
 */
public class E_StrLang<Node> extends ExprFunction2<Node> {

  public E_StrLang(Expr<Node> expr1, Expr<Node> expr2, QueryContext<Node> queryContext) {
  ...
  public Expr<Node> copy(Expr<Node> expr1, Expr<Node> expr2) {
    return new E_StrLang<Node>(expr1, expr2, queryContext);
  }
}
